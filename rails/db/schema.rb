...
ActiveRecord::Schema.define(version: 20150910152926) do
  ...
  add_index "food_nutrients", ["food_item_id"], name: "index_food_nutrients_on_food_item_id", using: :btree
  ...
  add_foreign_key "food_nutrients", "food_items"
end
